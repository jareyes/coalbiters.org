...
function display_daterange_helper(start_date, duration_m) {
  console.log("start_date", start_date, "duration_m", duration_m);
  // Start time
  ...
  end_date.setUTCMinutes(start_date.getUTCMinutes() + duration_m);
